# Use a versão local documentada

Para instalar e usar a fila finita de SBCs repetíveis, comece em [`README_LOCAL.md`](README_LOCAL.md). O texto abaixo é o README original do projeto-base MIT e não descreve todas as correções desta adaptação.
